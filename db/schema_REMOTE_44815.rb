...
ActiveRecord::Schema.define(version: 20150608181523) do
  ...
  add_index "providers", ["license_number", "licensing_state"], name: "index_providers_on_license_number_and_licensing_state", unique: true, using: :btree
